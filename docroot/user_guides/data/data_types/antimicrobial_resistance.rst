...
- `Amikacin <https://www.alpha.bv-brc.org/view/Antibiotic/?eq(antibiotic_name,amikacin)>`_
- `Ethambutol <https://www.palpha.bv-brc.org/view/Antibiotic/?eq(antibiotic_name,ethambutol)>`_
- `Isoniazid <https://www.alpha.bv-brc.org/view/Antibiotic/?eq(antibiotic_name,isoniazid)>`_
- `Rifampoin <https://www.alpha.bv-brc.org/view/Antibiotic/?eq(antibiotic_name,rifampoin)>`_
- `Streptomycin <https://www.alpha.bv-brc.org/view/Antibiotic/?eq(antibiotic_name,streptomycin)>`_
- `View all antibiotics <https://www.alpha.bv-brc.org/view/AntibioticList/?keyword(*)>`_
...
- `Mycobacterium <https://www.alpha.bv-brc.org/view/Taxonomy/1763#view_tab=amr>`_
- `Staphylococcus <https://www.alpha.bv-brc.org/view/Taxonomy/1279#view_tab=amr>`_
- `Streptococcus <https://www.alpha.bv-brc.org/view/Taxonomy/1301#view_tab=amr>`_
- `Acinetobacter <https://www.alpha.bv-brc.org/view/Taxonomy/469#view_tab=amr>`_
- `Pseudomonas <https://www.alpha.bv-brc.org/view/Taxonomy/286#view_tab=amr>`_
- `View all AMR phenotype data <https://www.alpha.bv-brc.org/view/Taxonomy/2#view_tab=amr>`_
...
- `CARD <https://www.alpha.bv-brc.org/view/Taxonomy/2#view_tab=specialtyGenes&filter=and(eq(property,%22Antibiotic%20Resistance%22),eq(source,%22CARD%22))>`_
- `NDARO <https://www.alpha.bv-brc.org/view/Taxonomy/2#view_tab=specialtyGenes&filter=and(eq(property,%22Antibiotic%20Resistance%22),eq(source,%22NDARO%22))>`_
- `PATRIC AMR <https://www.alpha.bv-brc.org/view/Taxonomy/2#view_tab=specialtyGenes&filter=and(eq(property,%22Antibiotic%20Resistance%22),eq(source,%22PATRIC%22))>`_
- `View all AMR genes <https://www.alpha.bv-brc.org/view/Taxonomy/2#view_tab=specialtyGenes&filter=eq(property,%22Antibiotic%20Resistance%22)>`_
...
- `View all AMR regions <https://www.alpha.bv-brc.org/view/FeatureList/?eq(feature_type,classifier_predicted_region)#view_tab=features&filter=or(eq(annotation,%22PATRIC%22))>`_
